        ...
        <div className="flex justify-between py-5 h-16">
          ...
          <div className="flex items-center">
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              <a to="/slide/0" className="text-white hover:text-yellow-500 px-3 py-2 rounded-md text-lg font-semibold">AI Analysis</a>
              <a to="/slide/1" className="text-white hover:text-yellow-500 px-3 py-2 rounded-md text-lg font-semibold">Resume score</a>
              <a to="/slide/2" className="text-white hover:text-yellow-500 px-3 py-2 rounded-md text-lg font-semibold">AI Auto Data</a>
              <a to="/slide/3" className="text-white hover:text-yellow-500 px-3 py-2 rounded-md text-lg font-semibold">Blogs</a>
              <a to="/" className="text-white px-2 py-2 text-lg font-semibold border-2  rounded-xl " id='home_fourth'>Log in</a>
              <a to="/" className="text-white hover:text-yellow-500 px-2 py-2 text-lg font-semibold border-2 rounded-xl">Sign up</a>
            </div>
             <div className="flex sm:hidden">
              <button
                onClick={() => setIsMenuOpen(!isMenuOpen)}
                className="text-white  focus:outline-none px-3 py-2 rounded-md text-sm font-medium"
              >
