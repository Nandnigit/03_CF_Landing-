...
//   return (
//     <>
//     <footer className=" border-t-2 text-black py-8 " id='footerbg'>
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex flex-col md:flex-row gap-4  ">
//           <div className="w-full md:w-1/3 mb-6 md:mb-0">
//             <h5 className="font-bold text-xl mb-4">Resume </h5>
//             <ul>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Resume Builder</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Resume Template</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Resume Example</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Resume formats</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">How to make a Resume</a></li>
//             </ul>
//           </div>
//           <div className="w-full md:w-1/3 mb-6 md:mb-0">
//             <h5 className="font-bold text-xl mb-4">Cover Letter </h5>
//             <ul>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Cover Letter Builder</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Cover Letter Template</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Cover Letter Example</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Cover Letter formats</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">How to make a Cover Letter</a></li>
//             </ul>
//           </div>
//           <div className="w-full md:w-1/3 mb-6 md:mb-0">
//             <h5 className="font-bold text-xl mb-4">CV </h5>
//             <ul>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">CV Builder</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">CV Template</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">CV Example</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">CV formats</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">How to make a CV</a></li>
//             </ul>
//           </div>
//           <div className="w-full md:w-1/3 mb-6 md:mb-0">
//             <h5 className="font-bold text-xl mb-4">Resume Now</h5>
//             <ul>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">About us</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Privacy Policy</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Terms of Services</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Cookies and tracking poilcy </a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Sitemap</a></li>
//             </ul>
//           </div>
//           <div className="w-full md:w-1/3 mb-6 md:mb-0">
//             <h5 className="font-bold text-xl mb-4">Support</h5>
//             <ul>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Contact</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">FAQ</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Accesibilty</a></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Affilates</a></li>
//             </ul>
//           </div>
...
//             </div> */}
//             <ul>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Phone Number:</a>
//               <li className=' text-gray-300'>9999999999</li></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">Email</a>
//               <li className=' text-gray-300'>customerservice@resume-now.com</li></li>
//               <li className="mb-2"><a href="#" className="text-gray-400 hover:text-black">CS Support Schedule</a>
...
const Footer = () => {
    return (
      ...
      {/* <div className='  py-4 flex justify-center border-b-2' id='footerbg'>
        ...
        <footer className="bg-purple-800 text-black py-8" id='footerbg'>
            <div className="container mx-auto flex flex-col gap-7 justify-between px-6">
              <div className=' flex flex-wrap justify-between px-2 md:px-[65px]'>
                ...
                <div className="w-full md:w-auto mb-6 md:mb-0">
                    <h2 className="text-lg font-bold text-black">Perfect Resume</h2>
                    <ul>
            ...
            <div className="container text-base md:mx-auto text-center border-t border-white pt-6 mt-6">
                <p className="text-black text-right">&copy; Copyright By Perfect Resume.com All Rights Reserved</p>
            </div>
        </footer>
        </>
    );
