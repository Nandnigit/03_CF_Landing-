  ...
  return (
    <div className="w-full p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-navy-700 text-white px-4 py-2 rounded">Back</button>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="bg-navy-700 text-white px-6 py-2 rounded">Save Setting</button>
      </form>
    </div>
  );
};
